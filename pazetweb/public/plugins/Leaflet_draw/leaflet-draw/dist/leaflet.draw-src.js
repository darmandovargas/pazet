...
L.drawLocal = {
		...
		handlers: {
			...
			polygon: {
				tooltip: {
					...
					cont: 'Clic para continuar forma de dibujo.',
					end: 'Haga clic en el primer punto para cerrar la forma.'
				}
			},
			polyline: {
				error: '<strong>Error:</strong> Las lineas no se pueden cruzar!',
				tooltip: {
					start: 'Haga clic para iniciar polilinea.',
					cont: 'Click para seguir dibujando polilinea.',
					end: 'Haga clic en el último punto para finalizar la polilinea.'
				}
			},
			rectangle: {
				tooltip: {
			...
			simpleshape: {
				tooltip: {
					end: 'Libere el mouse para terminar la figura.'
				}
			}
		}
	},
	edit: {
		...
		handlers: {
			edit: {
				tooltip: {
					text: 'Arrastre un punto de la figura para editar.',
					subtext: 'Haga clic en Cancelar para deshacer los cambios.'
				}
			},
			remove: {
				tooltip: {
					text: 'Haga clic en una figura para eliminar.'
				}
			}
		}
	}
