...
app.controller('ClimaMonthController', ['$scope','$http','Estaciones', function($scope,$http,Estaciones) {

	$scope.listEstaciones = [];
	$scope.listSeleccionados = [];

	var map = L.map('mapa_month',{
	...
	controlLoader.show();
	Estaciones.all_estn_clima_month_geojson().then(function(data) {
    ...
    function filtro(data, radio, type){
    	...
    	Estaciones.filtro_estn_in_poligon_cmonth_json(type,data,radio).then(function(data) {
	...
	$scope.searchWithDepto = function(){
		...
		if( codane == null || codane == '' ) {
			...
			Estaciones.estn_clima_month_depto_json(codane).then(function(data) {
	...
	$scope.searchWithMun = function(){
		...
		if( munid == null || munid == '' ) {
			...
			Estaciones.estn_clima_month_mun_json(munid).then(function(data) {
	...
	$scope.searchWithCodigo = function(){
		...
		if( codigo == null || codigo == '' ) {
			...
			Estaciones.estn_codigo_clima_month_json(codigo).then(function(data) {
	...
	$scope.searchWithName = function(){
		...
		if( nombre == null || nombre == '' ) {
			...
			Estaciones.estn_name_clima_month_json(nombre).then(function(data) {
