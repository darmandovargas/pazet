...
class AqFisioConserva(models.Model):
    ...
    aqfisioconser_wpnormal = models.FloatField("Productividad hídrica ET0 y CO2", blank=True, null=True)
...
class ReqFisico(models.Model):
    ...
    cul_id = models.ForeignKey(Cultivo, verbose_name="Cultivo")
    reqfis_drenaje_opt = models.CharField("Clase de Drenaje Óptimo", unique=True, max_length=15)
    reqfis_drenaje_mod = models.CharField("Clase de Drenaje Moderado", unique=True, max_length=15)
    reqfis_drenaje_rest = models.CharField("Clase de Drenaje Restrictivo", unique=True, max_length=15)
    ...
    reqfis_textura_opt = models.CharField("Textura Óptima", unique=True, max_length=15)
    reqfis_textura_mod = models.CharField("Textura Moderada", unique=True, max_length=15)
    reqfis_textura_rest = models.CharField("Textura Restringida", unique=True, max_length=15)
...
class TipoRiego(models.Model):
    ...
    cul_id = models.ForeignKey(Cultivo, verbose_name="Cultivo")
    tiporiego_metodo = models.SmallIntegerField("Tipo Riego Método")
...
class EventoRiego(models.Model):
    ...
    eventoriego_dia_n = models.CharField("Día Riego", unique=True, max_length=200)
    eventoriego_lamina_n = models.CharField("Lámina Aplicada", unique=True, max_length=200)
    eventoriego_cew_n = models.CharField("Conductividad Eléctrica", unique=True, max_length=200)
    eventoriego_gen_crit_tiempo = models.SmallIntegerField("Criterio de Tiempo")
    eventoriego_gen_crit_lamina = models.SmallIntegerField("Criterio de Lámina")
    eventoriego_gen_n = models.SmallIntegerField("Número de Eventos")
    eventoriego_gen_desdedia_n = models.CharField("Día Criterio Riego", unique=True, max_length=200)
    eventoriego_gen_intervalo_n = models.CharField("Intervalo Criterio Riego", unique=True, max_length=200)
    eventoriego_gen_lamina_n = models.CharField("Lámina de Aplicación", unique=True, max_length=200)
    eventoriego_gen_cew_n = models.CharField("Conductividad Eléctrica Riego", unique=True, max_length=200)
